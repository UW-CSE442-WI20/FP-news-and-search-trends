...
},{"./lib/axios":"nUiQ"}],"zfSF":[function(require,module,exports) {
var axios = require('axios');

function search() {
  var input = document.getElementById('searchbar').value.toLowerCase();
  console.log(input);
  axios.get('https://news-and-search-trends.zkeyes.now.sh').then(function (response) {
...
},{"axios":"dZBD"}]},{},["zfSF"], null)
//# sourceMappingURL=https://uw-cse442-wi20.github.io/FP-news-and-search-trends/search.861aae96.js.map